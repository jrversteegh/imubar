...
static void icm20948_convert_accel(const struct icm20948_config *config, int32_t raw_accel_value,
...
static int icm20948_mag_config(const struct device *dev)
{
	...
	err = i2c_reg_update_byte_dt(&config->i2c, I2C_MST_CTRL, BIT(7) | GENMASK(4, 0),
