...
#define LSM9DS0_GYRO_MASK_CTRL_REG2_G_HPCF (BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define LSM9DS0_GYRO_MASK_FIFO_CTRL_REG_G_WTM                                  \
...
#define LSM9DS0_GYRO_MASK_FIFO_SRC_REG_G_FSS                                   \
  (BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define LSM9DS0_GYRO_MASK_INT1_DURATION_G_D                                    \
  (BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
struct lsm9ds0_gyro_data {
  ...
  K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_LSM9DS0_GYRO_THREAD_STACK_SIZE);
