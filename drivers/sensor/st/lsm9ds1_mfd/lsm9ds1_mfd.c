...
static inline int lsm9ds0_mfd_sample_fetch_accel(const struct device *dev) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_X_L_A, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_X_H_A, &out_h) <
          0) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Y_L_A, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Y_H_A, &out_h) <
          0) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Z_L_A, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Z_H_A, &out_h) <
          0) {
...
static inline int lsm9ds0_mfd_sample_fetch_magn(const struct device *dev) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_X_L_M, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_X_H_M, &out_h) <
          0) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Y_L_M, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Y_H_M, &out_h) <
          0) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Z_L_M, &out_l) <
          0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_Z_H_M, &out_h) <
          0) {
...
static inline int lsm9ds0_mfd_sample_fetch_temp(const struct device *dev) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_TEMP_L_XM,
                           &out_l) < 0 ||
      i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_OUT_TEMP_H_XM,
                           &out_h) < 0) {
...
static int lsm9ds0_mfd_init_chip(const struct device *dev) {
  ...
  if (i2c_reg_read_byte_dt(&config->i2c, LSM9DS0_MFD_REG_WHO_AM_I_XM,
                           &chip_id) < 0) {
...
#define LSM9DS0_MFD_DEFINE(inst)                                               \
  ...
  SENSOR_DEVICE_DT_INST_DEFINE(                                                \
      inst, lsm9ds0_mfd_init, NULL, &lsm9ds0_mfd_data_##inst,                  \
      &lsm9ds0_mfd_config_##inst, POST_KERNEL, CONFIG_SENSOR_INIT_PRIORITY,    \
