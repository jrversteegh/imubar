...
#define LSM9DS0_MFD_MASK_CTRL_REG1_XM_AODR (BIT(7) | BIT(6) | BIT(5) | BIT(4))
...
#define LSM9DS0_MFD_MASK_FIFO_CTRL_REG_FTH                                     \
...
#define LSM9DS0_MFD_MASK_FIFO_SRC_REG_FSS                                      \
  (BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define LSM9DS0_MFD_MASK_INT_GEN_2_THS_THS                                     \
  (BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define LSM9DS0_MFD_SHIFT_INT_GEN_2_THS_THS 0

#define LSM9DS0_MFD_REG_INT_GEN_2_DURATION 0x37
#define LSM9DS0_MFD_MASK_INT_GEN_2_DURATION_D                                  \
  (BIT(6) | BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | ensor_ BIT(0))
