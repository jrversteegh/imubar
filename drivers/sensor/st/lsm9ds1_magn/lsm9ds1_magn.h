...
#define LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_MASK (3 << LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_SHIFT)
#define LSM9DS1_MAGN_REG_CTRL_REG1_ODR_SHIFT 2
#define LSM9DS1_MAGN_REG_CTRL_REG1_ODR_MASK (7 << LSM9DS1_MAGN_REG_CTRL_REG1_ODR_SHIFT)

#define LSM9DS1_MAGN_REG_CTRL_REG2 0x21
#define LSM9DS1_MAGN_REG_CTRL_REG2_FS_SHIFT 5
#define LSM9DS1_MAGN_REG_CTRL_REG2_FS_MASK (3 << LSM9DS1_MAGN_REG_CTRL_REG2_FS_SHIFT)
...
#define LSM9DS1_MAGN_REG_CTRL_REG4_Z_OPR_MASK (3 << LSM9DS1_MAGN_REG_CTRL_REG4_Z_OPR_SHIFT)

#define LSM9DS1_MAGN_REG_CTRL_REG5 0x24

#if defined(CONFIG_LSM9DS1_MAGN_TEMP_COMP)
#define LSM9DS1_MAGN_DEFAULT_TEMP_COMP (1 << LSM9DS1_MAGN_REG_CTRL_REG1_TEMP_COMP_SHIFT)
#else
#define LSM9DS1_MAGN_DEFAULT_TEMP_COMP (0 << LSM9DS1_MAGN_REG_CTRL_REG1_TEMP_COMP_SHIFT)
#endif

#if defined(CONFIG_LSM9DS1_MAGN_LOW_POWER)
#define LSM9DS1_MAGN_DEFAULT_XY_OPR (0 << LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_SHIFT)
#define LSM9DS1_MAGN_DEFAULT_Z_OPR (0 << LSM9DS1_MAGN_REG_CTRL_REG4_Z_OPR_SHIFT)
#elif defined(CONFIG_LSM9DS1_MAGN_MED_PERF)
#define LSM9DS1_MAGN_DEFAULT_XY_OPR (1 << LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_SHIFT)
#define LSM9DS1_MAGN_DEFAULT_Z_OPR (1 << LSM9DS1_MAGN_REG_CTRL_REG4_Z_OPR_SHIFT)
#elif defined(CONFIG_LSM9DS1_MAGN_HIGH_PERF)
#define LSM9DS1_MAGN_DEFAULT_XY_OPR (2 << LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_SHIFT)
#define LSM9DS1_MAGN_DEFAULT_Z_OPR (2 << LSM9DS1_MAGN_REG_CTRL_REG4_Z_OPR_SHIFT)
#elif defined(CONFIG_LSM9DS1_MAGN_ULTRA_PERF)
#define LSM9DS1_MAGN_DEFAULT_XY_OPR (3 << LSM9DS1_MAGN_REG_CTRL_REG1_XY_OPR_SHIFT)
